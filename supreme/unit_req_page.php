...
<?php
	...
	$units = mysqli_query($connect, "SELECT * FROM unites_req WHERE id='$unit_id'");
...
<!------------------------------------------------------------>
	...
	<?php 
		endwhile;
	?>
<div class="confirm_ref_btn">
	<a href="vendor/admin_refuse.php?unit_id=<?= $unit_id ?>" class="refuse">Отказать</a>
	<a href="vendor/admin_confirm.php?unit_id=<?= $unit_id ?>" class="confirm">Одобрить</a>
</div>